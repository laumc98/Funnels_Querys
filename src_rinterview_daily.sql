/* AA : channels performance : daily src ready for interview by campaign: prod */ 
SELECT
    date(occh.created) AS 'date',
    tc.utm_campaign AS 'utm_campaign_src_ri',
    count(distinct occh.candidate_id) AS 'count_ri_src'
FROM
