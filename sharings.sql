SELECT "atomic"."com_torrelabs_referrer_token_generated_1"."root_tstamp" AS "date", "atomic"."com_torrelabs_referrer_token_generated_1"."user_gg_id" AS "gg_id",SUBSTRING("atomic"."com_torrelabs_referrer_token_generated_1"."action" , 13, 20) AS "AlfaID" 
