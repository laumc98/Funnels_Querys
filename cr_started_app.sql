...
WHERE
  ...
  AND tc.utm_campaign IN ('amdm','mcog','dffa','czp','jdpb','dmc','nsr','mmor','JAMC','mgdd','mrh','srl','avs','sbr','tavp','rmr' ,'dgv','MER','ACMP','dgc','fcr','mes','mcmn','mfo','smfp','gebj','aamf','eb','kglm','sm','brc','vaio','exrm','jsmn','lfas','malm','lbmp','capi','cals','bb','jcmv','egc','mdr')
